...
function _handleAsyncAwaitGenerator() {
  _handleAsyncAwaitGenerator = _wrapAsyncGenerator(
  /*#__PURE__*/
...
export var cloneArray = _toConsumableArray(myArray);

var _cloneArray = _toArray(cloneArray),
    first = _cloneArray[0],
    second = _cloneArray[1],
    restArray = _cloneArray.slice(2);
...
export var isValidNum = myArray.every(function (val) {
  return val < 3;
});
